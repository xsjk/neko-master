"use client";
import { RuleDistribution, type RuleChartItem } from "./rule-distribution";
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-12 gap-6">
        <RuleDistribution chartData={chartData} selectedRule={selectedRule} onSelect={handleRuleClick} />
